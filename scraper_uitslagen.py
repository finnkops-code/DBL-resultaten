"""
DBL Uitslagen Scraper
Haalt gespeelde wedstrijden op via expliciete week-URL.
Schrijft alleen "uitslagen" in schedule.json.
"""
...
def main():
    ...
    for u in uitslagen:
        print(f"  {u['datum']} {u['tijdstip']}  {u['uit']} {u['score_uit']}–{u['score_thuis']} {u['thuis']}")
    ...
    print(f"✅ {len(uitslagen)} uitslagen opgeslagen")
